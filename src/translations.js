...
export const translations = {
  en: {
    ...
    common: {
      ...
      viewSummerCamp: "☀️ View Summer Camp",
    ...
    home: {
      ...
      section3Text1:
        "Tournaments give students real-game experience and help them apply what they learn under pressure. They develop focus, resilience, and stronger decision-making.",
      section3Text2:
    ...
    programs: {
      ...
      stat3n: "8+",
      stat3l: "Years of Experience",
      stat4n: "6–16",
      stat4l: "Age Range",
      ctaTitle: "Not sure which program fits best?",
      ctaText:
      ...
      programs: [
        ...
        },
        {
          ...
          age: "Ages 6–16",
          level: "All Levels",
          desc: "One-on-one coaching tailored entirely to your child. Whether they are a complete beginner or preparing for competition, private lessons offer the fastest and most focused improvement.",
          highlights: [
        ...
        },
        {
          ...
          desc: "Structured training for students who compete in scholastic tournaments. Includes opening preparation, game analysis, endgame technique, and the mental skills needed to perform under pressure.",
          highlights: [
        ...
        },
        {
          ...
          age: "Ages 6–16",
          level: "All Levels",
          desc: "Intensive week-long summer camps combining structured lessons, practice games, puzzles, and fun activities. Students improve quickly while making lasting friendships.",
          highlights: [
    ...
    camp: {
      ...
      sub: "Intensive chess training, real tournament experience, and a fun learning environment where students build skill, confidence, and friendships.",
      noSessions: "No camp sessions have been scheduled yet.",
      perChild: "/ child",
      contact: "Contact Us",
      signUp: "Sign Up Now",
      ...
      regModal: {
        ...
        medicalPh: "Anything we should know...",
        submitBtn: "Submit Registration →",
        successTitle: "You're registered!",
        successSub: "Confirmation details will be sent to your email address.",
    ...
    team: {
      ...
      ctaTitle: "Need help choosing the right coach?",
      ctaText:
        "We can help you find the best fit based on your child’s age, level, goals, and learning style.",

      cards: [
        {
          role: "Head Coach",
          bio: "10+ years of experience coaching youth chess. Loves teaching endgames and helping kids build confidence.",
        ...
        },
        {
          ...
          bio: "Designs our summer camp experience and makes every week organized, fun, and memorable.",
          tags: ["Camps", "Logistics", "Community"],
        },
        {
          role: "Strategy Coach",
          bio: "Focuses on middlegame planning and practical decision-making under time pressure.",
    ...
    contactModal: {
      ...
      fastest: "For the fastest response, email us.",
    },
    ...
    admin: {
      ...
      stats: {
        ...
        revenue: "Estimated Camp Revenue",
      },
    ...
    toast: {
      ...
      fallbackData:
        "Using fallback local data. Start the backend server for sync.",
    },
  },
  ...
  ru: {
    ...
    common: {
      ...
      viewSummerCamp: "☀️ Смотреть лагерь",
    ...
    home: {
      ...
      heroSub:
        "Присоединяйтесь к MyChessFamily — ведущему шахматному клубу Нью-Йорка для детей и подростков. Мы развиваем стратегическое мышление, уверенность в себе и крепкую дружбу с помощью шахмат.",
      heroBtn1: "♟ Изучить программы",
      heroBtn2: "☀️ Летний лагерь",
      heroBtn3: "✉️ Связаться с нами",
      stat1n: "500+",
      stat1l: "Юных игроков",
      stat2n: "8+",
      stat2l: "Лет работы",
      ...
      offer4Desc:
        "Групповые занятия, где ученики вместе готовятся к турнирам и укрепляют навыки в командной атмосфере.",
      offer5Title: "Шахматные лагеря",
      offer5Desc:
        "Интенсивные шахматные лагеря, сочетающие тренировки, турниры и интересные совместные активности.",
      ...
      section2Title: "Персональный подход",
      section2Text1:
        "Каждый ученик учится по-своему. Наши тренеры выстраивают личный контакт с детьми, чтобы понять их стиль мышления, мотивацию и темп обучения.",
      section2Text2:
        "Благодаря индивидуальным занятиям и целенаправленной поддержке ученики получают обучение, соответствующее их уровню, и уверенно прогрессируют.",
      section2Btn: "Смотреть программы",
      section3Title: "Шахматные турниры",
      section3Text1:
        "Турниры дают ученикам опыт реальных партий и помогают применять знания под давлением. Они развивают концентрацию, стойкость и умение принимать решения.",
      section3Text2:
        "Мы поощряем здоровую конкуренцию, спортивное поведение и стабильный рост через события, которые бросают вызов игрокам и при этом сохраняют позитивную и вдохновляющую атмосферу.",
      ...
      section4Text2:
        "Ученики совершенствуют шахматные навыки, заводят друзей и получают яркий, запоминающийся опыт, который поддерживает их интерес и мотивацию.",
      section4Btn: "Записаться в лагерь",
      section5Title: "Школьные шахматные программы",
      section5Text1:
        "My Chess Family сотрудничает со школами, чтобы приносить качественное шахматное образование прямо в учебную среду через внеклассные программы.",
      section5Text2:
        "Эти программы помогают ученикам развивать концентрацию, терпение и навыки решения задач, знакомя их со стратегическим миром шахмат.",
      section5Btn: "Связаться с нами",
      aboutLabel: "О нас",
      aboutTitle: "О My Chess Family",
      aboutText1:
        "MyChessFamily — это детско-юношеское шахматное сообщество, созданное для того, чтобы помогать ученикам расти в мастерстве, уверенности и характере через продуманное и увлекательное обучение.",
      aboutText2:
        "От первых занятий до серьёзной соревновательной подготовки — мы стремимся к тому, чтобы каждый ученик чувствовал поддержку, получал нужный вызов и с интересом совершенствовался.",
      aboutText3:
        "Наша цель — не только хорошо учить шахматам, но и создавать сильную, позитивную среду, где ученики и семьи чувствуют себя частью чего-то важного.",
    ...
    programs: {
      ...
      heroSub:
        "От внеклассных программ для начинающих до серьёзной турнирной подготовки — каждая программа создана так, чтобы ваш ребёнок мог развиваться в своём темпе.",
      heroBtn1: "✉️ Узнать о стоимости",
      heroBtn2: "☀️ Летний лагерь",
      stat1n: "5",
      stat1l: "Программ",
      stat2n: "500+",
      ...
      stat4n: "6–16",
      stat4l: "Возраст",
      ctaTitle: "Не знаете, какая программа подойдёт лучше всего?",
      ctaText:
        "Мы лично помогаем каждой семье подобрать лучший вариант с учётом возраста, опыта и целей ребёнка. Просто напишите нам — мы подскажем.",
      programs: [
        {
          ...
          age: "Возраст 6–16",
          level: "Все уровни",
          desc: "Внеклассные шахматные программы, где ученики изучают основы шахмат в структурированной и увлекательной среде. Мы напрямую сотрудничаем со школами, чтобы предоставлять качественное шахматное обучение прямо в школе.",
          highlights: [
            "Стратегическое мышление и решение задач",
            "Структурированная программа по уровням",
            "Партнёрские программы со школами",
            "Информация о прогрессе для родителей",
          ],
        ...
        },
        {
          ...
          tag: "Один на один",
          price: "От $80 / занятие",
          duration: "60 или 90 минут",
          age: "Возраст 6–16",
          level: "Все уровни",
          desc: "Индивидуальные занятия, полностью адаптированные под вашего ребёнка. Независимо от того, только ли он начинает или уже готовится к соревнованиям, такие занятия дают самый быстрый и наиболее заметный прогресс.",
          highlights: [
        ...
        },
        {
          ...
          age: "Возраст 8–16",
          level: "Средний – продвинутый уровень",
          desc: "Структурированные тренировки для учеников, участвующих в школьных турнирах. Дебютная подготовка, анализ партий, техника эндшпиля и психологические навыки, необходимые для игры под давлением.",
          highlights: [
            "Построение дебютного репертуара",
            "Анализ партий и ошибок",
            "Тренировка эндшпиля и тактики",
        ...
        },
        {
          ...
          desc: "Совместные групповые занятия, где ученики вместе готовятся к турнирам, анализируют партии и помогают друг другу прогрессировать в командной учебной среде.",
          highlights: [
            "Командная стратегия и взаимодействие",
            "Совместный анализ партий",
            "Обучение в группе",
        ...
        },
        {
          ...
          price: "От $350 / неделя",
          duration: "Полный день или полдня",
          age: "Возраст 6–16",
          level: "Все уровни",
          desc: "Интенсивные недельные летние лагеря, сочетающие структурированные занятия, тренировочные партии, задачи и весёлые активности. Ученики быстро прогрессируют и заводят крепкие дружеские связи.",
          highlights: [
            "Варианты полного и неполного дня",
            "Подходят для всех уровней",
            "Ежедневные задачи и игры",
            "Небольшие группы",
          ],
    ...
    camp: {
      ...
      sub: "Интенсивные шахматные тренировки, практический турнирный опыт и увлекательная учебная среда, где ученики развивают мастерство, уверенность и дружбу.",
      noSessions: "Пока нет запланированных смен лагеря.",
      perChild: "/ ребёнок",
      contact: "Связаться",
      ...
      regModal: {
        title: "Запись:",
        firstName: "Имя",
        firstNamePh: "например, Алекс",
        lastName: "Фамилия",
        lastNamePh: "например, Иванов",
        dob: "Дата рождения",
        level: "Уровень игры",
        levelPh: "Выберите уровень",
        levelOpts: [
          "Никогда раньше не играл(а)",
          "Знает основы",
          "Играет регулярно",
          "Турнирный игрок",
        ],
        ...
        phone: "Телефон",
        phonePh: "(212) 555-0000",
        emergency: "Контакт на случай экстренной ситуации",
        emergencyPh: "Имя · (212) 555-0001",
        medical: "Аллергии / Медицинские заметки",
        medicalPh: "Любая важная информация для нас...",
        submitBtn: "Отправить заявку →",
        successTitle: "Вы зарегистрированы!",
        successSub: "Подтверждение будет отправлено на ваш email.",
    ...
    team: {
      kicker: "Наша команда",
      heroTitle: "Опытные тренеры. Личный подход. Настоящий рост.",
      heroSub:
        "My Chess Family объединяет преданных педагогов, сильных игроков и опытных наставников, которые помогают ученикам расти в мастерстве, уверенности и характере через шахматы.",
      founderRole: "Основатель и главный тренер",
      founderName: "Дмитрий Шевелев",
      founderP1:
        "My Chess Family была основана ФИДЕ-мастером Дмитрием Шевелевым — опытным шахматным педагогом, который десятилетиями учит детей мыслить стратегически, уверенно соревноваться и расти через игру.",
      founderP2:
        "Его педагогическая философия строится на эмпатии, дисциплине и личном контакте. Каждый ученик уникален, и цель состоит в том, чтобы подобрать каждому ребёнку правильную поддержку, подходящий темп и лучшую среду для долгосрочного роста.",
      founderP3:
        "Под его руководством My Chess Family превратилась в сообщество, где ученики получают сильную шахматную подготовку и одновременно развивают стойкость, концентрацию и характер.",
      coachTitle: "Наша тренерская команда",
      coachSub:
        "В нашу команду входят дружелюбные и профессиональные тренеры, которые умеют делать обучение шахматам увлекательным, поддерживающим и полезным для учеников любого уровня.",
      feat1Title: "Персонализированное обучение",
      feat1Text:
        "Тренеры учитывают личность, уровень и стиль обучения каждого ученика, чтобы сделать процесс более эффективным и вдохновляющим.",
      feat2Title: "Соревновательный опыт",
      feat2Text:
        "Ученики занимаются с тренерами, которые хорошо понимают турнирную игру и помогают готовиться с помощью стратегии, дисциплины и практического подхода.",
      feat3Title: "Поддерживающее сообщество",
      feat3Text:
        "Помимо обучения, наша команда создаёт тёплую атмосферу, где ученики чувствуют мотивацию, уважение и желание становиться лучше.",
      ctaTitle: "Нужна помощь в выборе тренера?",
      ctaText:
        "Мы поможем подобрать лучший вариант с учётом возраста, уровня, целей и стиля обучения вашего ребёнка.",

      cards: [
        {
          role: "Главный тренер",
          bio: "Более 10 лет тренирует детей в шахматах. Любит преподавать эндшпиль и помогать детям становиться увереннее.",
          tags: ["Эндшпиль", "Подготовка к турнирам", "Наставничество"],
        },
        {
          role: "Младший тренер",
          bio: "Бывший чемпион штата среди школьников. Специализируется на начинающих и построении крепкой базы.",
          tags: ["Начинающие", "Тактика", "Уверенность"],
        },
        {
          role: "Координатор лагеря",
          bio: "Организует нашу летнюю шахматную программу и делает каждую неделю интересной, весёлой и отлично продуманной.",
    ...
    reviews: {
      ...
      heroTitle: "Что семьи говорят о нас",
      heroSub:
        "Отзывы учеников и семей, которые познакомились с My Chess Family через занятия, лагеря, турниры и долгосрочное обучение.",
      ratingMeta: "На основе",
      ratingMetaEnd: "отзыва",
      ratingMetaEndPlural: "отзывов",
      stat1Label: "Средняя оценка",
      stat2Label: "Опубликованные отзывы",
      stat3n: "100%",
      stat3Label: "Фокус на развитии ученика",
      noReviews: "Пока нет одобренных отзывов",
      noReviewsSub: "Станьте первой семьёй, которая поделится своим опытом.",
    ...
    about: {
      ...
      heroSub:
        "My Chess Family помогает детям развивать стратегическое мышление, уверенность, стойкость и характер через качественное шахматное образование в поддерживающей и вдохновляющей среде.",
      storyTitle: "Наша история",
      storyP1:
        "My Chess Family — это образовательная шахматная программа, созданная для того, чтобы помогать детям расти не только как игрокам, но и как личностям. Благодаря структурированным тренировкам, турнирному опыту и поддерживающему наставничеству ученики приобретают навыки, выходящие далеко за пределы шахматной доски.",
      storyP2:
        "Программа объединяет опытных тренеров, игроков мастерского уровня и гроссмейстеров, чтобы создать сильную учебную среду для учеников всех уровней — от полных новичков до серьёзных турнирных игроков.",
      storyP3:
        "Особенность My Chess Family — в чувстве настоящей связи. Ученики, тренеры и семьи становятся частью сообщества, построенного на поддержке, дисциплине и долгосрочном развитии.",
      founderSectionTitle: "Создано с целью",
      founderSectionSub:
        "В основе My Chess Family лежат сильное преподавание, эмпатия и вера в то, что каждый ребёнок может расти через шахматы.",
      founderRole: "Основатель и главный тренер",
      founderName: "Дмитрий Шевелев",
      founderP1:
        "My Chess Family была основана ФИДЕ-мастером Дмитрием Шевелевым — опытным шахматным педагогом с более чем двадцатилетним опытом преподавания. Он начал играть в шахматы в шесть лет и преподавать в восемнадцать, позже продолжив свою работу в США.",
      founderP2:
        "За эти годы Дмитрий обучил тысячи учеников через школьные программы, индивидуальные занятия, лагеря и турнирную подготовку. Среди его учеников были как дети, впервые знакомившиеся с игрой, так и продвинутые игроки, готовившиеся к серьёзным соревнованиям.",
      founderP3:
        "Его философия проста: каждый ребёнок уникален, а лучшее обучение происходит тогда, когда тренеры понимают, как ученик думает, учится и обретает уверенность.",
      valuesTitle: "Что мы помогаем развивать",
      valuesSub:
        "Шахматы служат образовательным инструментом для развития практических навыков, эмоциональной устойчивости и долгосрочной уверенности.",
      ...
      value2Text:
        "Шахматы помогают ученикам улучшать сосредоточенность, терпение и способность работать со сложными задачами.",
      value3Title: "Уверенность и стойкость",
      value3Text:
        "Ученики учатся справляться с ошибками, восстанавливаться после поражений и продолжать совершенствоваться с зрелостью и верой в себя.",
      ...
      ctaText:
        "Независимо от того, только ли начинает ваш ребёнок или уже участвует в соревнованиях, My Chess Family предлагает поддерживающую среду для обучения, роста и развития с уверенностью.",
      ...
      faqs: [
        ...
        {
          q: "Нужен ли ребёнку опыт игры в шахматы перед началом занятий?",
          a: "Нет. Мы принимаем как полных новичков, так и опытных турнирных игроков, и сопровождаем каждого ребёнка с учётом его уровня и темпа.",
        },
        {
          q: "Предлагаете ли вы индивидуальные занятия?",
          a: "Да. Мы предлагаем индивидуальное обучение для учеников, которым нужно больше персонализированного внимания, более быстрый прогресс или целенаправленная турнирная подготовка.",
        },
        {
          q: "Что происходит в летнем лагере?",
          a: "Наши летние лагеря сочетают структурированные занятия, тренировочные партии, решение задач, интересные активности и поддерживающую атмосферу, которая помогает ученикам оставаться вовлечёнными.",
        },
        {
          q: "Работаете ли вы со школами и организациями?",
          a: "Да. Мы сотрудничаем со школами, чтобы проводить внеклассные шахматные программы, и можем помочь создать подходящий формат для учеников и сообществ.",
        },
        {
          q: "Как выбрать подходящую программу для ребёнка?",
          a: "Мы помогаем семьям выбрать лучший вариант с учётом возраста, текущего уровня, целей и стиля обучения. Свяжитесь с нами, и мы подскажем лично.",
        },
      ],
    },
    ...
    gallery: {
      ...
      heroSub:
        "Взгляд на наши занятия, летние лагеря и моменты, которые делают наше шахматное сообщество особенным. Настоящие ученики. Настоящий рост. Настоящие воспоминания.",
      stat1n: "500+",
      stat1l: "Учеников",
      stat2n: "8+",
      stat2l: "Лет ярких воспоминаний",
      stat3n: "3",
      stat3l: "Лагеря в год",
      filterAll: "Все фото",
      ...
      ctaText:
        "Каждая фотография здесь — это история ученика, который выбрал учиться, соревноваться и расти. Присоединяйтесь к нам и создайте свои собственные воспоминания за шахматной доской.",
    },

    /* ── CONTACT PAGE ── */
    contact: {
      kicker: "Свяжитесь с нами",
      heroTitle: "Мы будем рады вашему сообщению",
      heroSub:
        "Есть вопросы о наших программах, лагерях или индивидуальных занятиях? Заполните форму, и мы ответим вам в течение 24 часов.",
      info: [
        {
          label: "Местоположение",
          value: "Нью-Йорк",
          note: "Работаем по всем районам Нью-Йорка и в ближайших окрестностях",
        },
        {
          label: "Email",
          value: "mychessfamily@gmail.com",
        ...
        },
        {
          ...
          note: "Восточное время · По воскресеньям закрыто",
        },
        {
          label: "Время ответа",
          value: "В течение 24 часов",
          note: "Обычно значительно быстрее в рабочее время",
        },
      ],
      ...
      formSub:
        "Расскажите о вашем ребёнке, о том, что вы ищете, и задайте любые вопросы. Мы лично ответим вам и предложим лучшие варианты.",
      firstName: "Имя",
      firstNamePh: "например, Алекс",
      lastName: "Фамилия",
      lastNamePh: "например, Иванов",
      ...
      subject: "Тема",
      subjectPh: "например, Вопрос о стоимости летнего лагеря",
      message: "Сообщение",
      messagePh:
        "Расскажите о возрасте вашего ребёнка, его уровне и о том, чего вы хотите достичь...",
      errRequired: "Пожалуйста, заполните все обязательные поля.",
      errEmail: "Пожалуйста, введите корректный email-адрес.",
      privacy:
        "Отправляя эту форму, вы соглашаетесь на то, что мы свяжемся с вами по поводу программ MyChessFamily. Мы никогда не передаём ваши данные третьим лицам.",
      successTitle: "Сообщение получено!",
      successSub1: "Спасибо за обращение. Мы ответим вам в течение 24 часов на",
      successSub2:
        "А пока вы можете ознакомиться с нашими программами или узнать больше о летнем лагере.",
      sendAnother: "Отправить ещё одно сообщение",
      ctaTitle: "Готовы начать?",
      ctaText:
        "Присоединяйтесь к сотням нью-йоркских учеников, которые выросли в мастерстве, уверенности и характере благодаря MyChessFamily. Первый шаг — просто написать нам.",
    },
    ...
    contactModal: {
      ...
      fastest: "Для самого быстрого ответа напишите нам на email.",
    },
    ...
    chatbot: {
      ...
      welcome:
        "Привет! Я помощник MyChessFamily. Спросите меня о программах, лагерях, индивидуальных занятиях или возрастных группах.",
      fallback:
        "Извините, я не могу ответить прямо сейчас. Пожалуйста, напишите на mychessfamily@gmail.com.",
    },

    /* ── 404 PAGE ── */
    notFound: {
      code: "404",
      title: "Похоже, эта страница сделала невозможный ход",
      sub: "Страница, которую вы ищете, не существует или была перемещена. Не переживайте — даже гроссмейстеры иногда ошибаются. Давайте вернём вас обратно к игре.",
      btn1: "♔ На главную",
      btn2: "♟ Смотреть программы",
    },

    /* ── LOGIN PAGE ── */
    login: {
      title: "Вход для администратора",
      sub: "Войдите, чтобы управлять лагерями и просматривать регистрации.",
    ...
    admin: {
      ...
      tabs: {
        ...
        campregs: "🏕 Регистрации в лагерь",
        reviews: "⭐ Отзывы",
        gallery: "📸 Галерея",
      },
      stats: {
        sessions: "Смены лагеря",
        signups: "Регистрации в лагерь",
        revenue: "Примерный доход от лагеря",
      },
      addCamp: "➕ Добавить новую смену лагеря",
      editCamp: "✏️ Редактировать смену лагеря",
      fields: {
        name: "Название смены лагеря",
        namePh: "например, Summer Chess Camp – Session 3",
        startDate: "Дата начала",
        endDate: "Дата окончания",
        location: "Место проведения",
        locationPh: "например, Chess Club HQ",
        type: "Тип смены",
        age: "Возрастная группа",
        price: "Стоимость за ребёнка ($)",
        pricePh: "например, 350",
        spots: "Максимум мест",
        spotsPh: "например, 20",
        status: "Статус",
        image: "Изображение лагеря",
        desc: "Описание",
        descPh: "Что входит в эту смену...",
      },
      ...
      ageOpts: [
        "Все возраста (6–16)",
        "Младшие (6–10)",
        "Средняя группа (11–13)",
        "Старшие (14–16)",
      ],
      addBtn: "Добавить смену лагеря →",
      updateBtn: "Обновить смену лагеря →",
      published: "✅ Смена лагеря опубликована!",
      updated: "✅ Лагерь обновлён!",
      allSessions: "Все смены лагеря",
      noSessions: "Пока нет смен лагеря.",
      signupsTitle: "Регистрации в лагерь",
      noSignups: "Пока нет регистраций в лагерь.",
      reviewsTitle: "Отзывы",
      noReviews: "Пока нет отзывов.",
      galleryTitle: "Фотографии галереи",
      noPhotos: "Фотографии пока не загружены.",
      uploadTitle: "📸 Загрузить новое фото",
      galleryFields: {
        photo: "Фото",
        caption: "Подпись",
        captionPh: "например, Ученики в летнем лагере 2024",
        category: "Категория",
        tag: "Тег (необязательно)",
        tagPh: "например, Летний лагерь 2024",
      },
      categoryOpts: [
      ...
      deleteConfirmCamp: "Удалить эту смену лагеря?",
      deleteConfirmSignup: "Удалить эту регистрацию в лагерь?",
      deleteConfirmReview: "Удалить этот отзыв?",
      deleteConfirmPhoto: "Удалить это фото?",
      statusUpdated: "Статус обновлён!",
      deleted: "Удалено.",
      approved: "✅ Одобрено!",
      signupDeleted: "Регистрация удалена.",
    },
    ...
    toast: {
      ...
      loggedIn: "✅ С возвращением, Admin!",
      loggedOut: "👋 Вы вышли из системы.",
      fallbackData:
        "Используются локальные данные. Запустите backend-сервер для синхронизации.",
    },
  },
  ...
  he: {
    ...
    common: {
      ...
      viewSummerCamp: "☀️ צפה במחנה הקיץ",
    ...
    home: {
      ...
      heroSub:
        "הצטרפו ל-MyChessFamily — מועדון שחמט מוביל בניו יורק לילדים ולנוער. אנחנו מפתחים חשיבה אסטרטגית, ביטחון עצמי וחברויות משמעותיות דרך משחק השחמט.",
      ...
      section4Text2:
        "התלמידים מחזקים את כישורי השחמט שלהם, בונים חברויות ונהנים מחוויה בלתי נשכחת ששומרת על מעורבות ומוטיבציה גבוהה.",
      ...
      programs: [
        {
          ...
          age: "גילאי 6–16",
          level: "כל הרמות",
          desc: "תוכניות שחמט לאחר שעות הלימודים שבהן התלמידים לומדים את יסודות המשחק בסביבה מובנית ומעניינת. אנו משתפים פעולה ישירות עם בתי ספר כדי להביא הדרכת שחמט איכותית ישירות לבית הספר.",
          highlights: [
    ...
    team: {
      ...
      cards: [
        ...
        {
          role: "רכז/ת מחנה הקיץ",
          bio: "אחראי/ת על חוויית מחנה הקיץ שלנו ודואג/ת שכל שבוע יהיה מאורגן, מהנה ובלתי נשכח.",
          tags: ["מחנות", "לוגיסטיקה", "קהילה"],
        },
        {
          role: "מאמן אסטרטגיה",
          bio: "מתמקד/ת בתוכניות משחק במשחק האמצע ובקבלת החלטות מעשית תחת לחץ זמן.",
    ...
    toast: {
      ...
      loggedOut: "👋 התנתקת.",
      fallbackData:
        "נעשה שימוש בנתונים מקומיים. הפעל את השרת האחורי לצורך סנכרון.",
    },
  },
};
